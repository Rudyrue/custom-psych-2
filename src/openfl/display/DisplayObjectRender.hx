...
#if !flash
#if !macro
import funkin.backend.utils.BitmapDataUtil;
#end
			...
			if (needRender)
			{
				...
				if (filterWidth >= 0.5 && filterHeight >= 0.5)
				{
					...
					if (displayObject.__cacheBitmapData == null
						...
						|| bitmapHeight != displayObject.__cacheBitmapData.height)
					{
						if (displayObject.__cacheBitmapData == null) displayObject.__cacheBitmapData = BitmapDataUtil.create(bitmapWidth, bitmapHeight);
						else BitmapDataUtil.resize(displayObject.__cacheBitmapData, bitmapWidth, bitmapHeight);
					...
					BitmapDataUtil.clear(displayObject.__cacheBitmapData, bitmapColor);
				}
				else
				{
			...
			if (needRender)
			{
				...
				if (displayObject.__cacheBitmapRenderer.__type == OPENGL)
				{
					...
					if (hasFilters)
					{
						...
						{
							displayObject.__cacheBitmapData2 = BitmapDataUtil.create(bitmapWidth, bitmapHeight);
						}
						else if (bitmapWidth != displayObject.__cacheBitmapData2.width || bitmapHeight != displayObject.__cacheBitmapData2.height)
						{
							BitmapDataUtil.resize(displayObject.__cacheBitmapData2, bitmapWidth, bitmapHeight);
							BitmapDataUtil.clear(displayObject.__cacheBitmapData2);
						}
						else
						{
							BitmapDataUtil.clear(displayObject.__cacheBitmapData2);
						...
						if (needCopyOfOriginal)
						{
							...
							{
								displayObject.__cacheBitmapData3 = BitmapDataUtil.create(bitmapWidth, bitmapHeight);
							}
							else if (bitmapWidth != displayObject.__cacheBitmapData3.width || bitmapHeight != displayObject.__cacheBitmapData3.height)
							{
								BitmapDataUtil.resize(displayObject.__cacheBitmapData3, bitmapWidth, bitmapHeight);
								BitmapDataUtil.clear(displayObject.__cacheBitmapData3);
							}
							else
							{
								BitmapDataUtil.clear(displayObject.__cacheBitmapData3);
